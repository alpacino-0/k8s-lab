...
-- and an install that needs the second sentence needs this engine. The rules that follow
...
--
-- Booleans are stored as INTEGER with a CHECK rather than as PostgreSQL BOOLEAN,
